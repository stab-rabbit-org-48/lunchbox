        ...
        <div className='bodyContainer'>
          <div className='main-elements-container'>
            <div className='quick-ingredients'>
              <div className='quick-ingredients-title'>
                {' '}
                Choose Your Protein
              </div>
              ...
              <div className='recipes-list'>
                <Link to='/recipe'>
                  <div className='recent-recipe'>
                    <div className='recent-recipe-title'>
                      {' '}
                      Honey Garlic Chicken
                    </div>
                    <div className='recent-recipe-nutrition'>
                      Cal: 583 Protein: 58g Carb: 43g Fat: 20g{' '}
                    </div>
                    <div className='recent-recipe-ingred'>
                      {' '}
                      Chicken, Rice, Broccoli, Quinoa...
                    </div>
                  </div>
                </Link>
                <Link to='recipe'>
                  <div className='recent-recipe'>
                    ...
                    <div className='recent-recipe-nutrition'>
                      Cal: 254 Protein: 63g Carb: 10g Fat: 87g
                    </div>
                    <div className='recent-recipe-ingred'>
                      Tofu, Siracha, Green Onions, Cornstarch...
                    </div>
                  </div>
                </Link>
                <Link to='recipe'>
